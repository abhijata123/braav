...
import { Save, Loader2, Upload, X, Share2, Copy, Wallet, Eye, EyeOff } from 'lucide-react';
...
export const UserDetails: React.FC = () => {
  ...
  const [copyingWallet, setCopyingWallet] = useState(false);
            ...
            <div className="space-y-4">
              ...
              {walletInfo?.wallet_address ? (
                <div className="bg-gray-800 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 relative">
                      <input
                        type="text"
                        value={showWalletAddress ? walletInfo.wallet_address : '••••••••••••••••••••••••••••••••••••••••'}
                        readOnly
                        className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 font-mono text-sm border border-gray-600 focus:outline-none cursor-default"
                      />
                    </div>
                    <button
                      onClick={handleCopyWalletAddress}
                      disabled={copyingWallet}
                ...
                <div className="bg-gray-800 rounded-lg p-4 text-center">
                  <Wallet className="h-8 w-8 text-gray-500 mx-auto mb-2" />
                  <p className="text-gray-400 text-sm">No wallet address found</p>
                  <p className="text-gray-500 text-xs mt-1">
                    Your wallet address will appear here once created
                  </p>
                </div>
              )}
            </div>
